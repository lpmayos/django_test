...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'World.creation_date'
        db.add_column(u'adventure_time_world', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'World.creation_date'
        db.delete_column(u'adventure_time_world', 'creation_date')
