...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'adventure_time_location', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locations', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.owner'
        db.delete_column(u'adventure_time_location', 'owner_id')
    ...
    models = {
        u'adventure_time.location': {
            ...
            'world': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'locations'", 'to': u"orm['adventure_time.World']"})
        },
        u'adventure_time.world': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'worlds'", 'null': 'True', 'to': u"orm['auth.User']"}),
