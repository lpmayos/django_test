...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'World.owner'
        db.add_column(u'adventure_time_world', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='worlds', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'World.owner'
        db.delete_column(u'adventure_time_world', 'owner_id')
